...
func Tail(opts TailOpts) error {
	...
	return network.Serve(ctx, addr, route, buildTailHandler(opts.Format, opts.NoColor))
}

func buildTailHandler(format string, noColor bool) http.Handler {
